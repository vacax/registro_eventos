...
<head>
  ...
  <![endif]-->
    ...
    <!-- DataTable -->
    <link rel="stylesheet" href="/webjars/AdminLTE/2.4.0/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/" class="logo">
            ...
            <span class="logo-lg"><b>Registro</b><small> Eventos</small></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="/webjars/AdminLTE/2.4.0/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><g:link controller="registro" action="lista"><i class="fa fa-book"></i> <span>Registro</span></g:link></li>
                <li><g:link controller="movEntradaSalida" action="lista"><i class="fa fa-book"></i> <span>Entradas/Salidas</span></g:link></li>
                <li><g:link controller="movEntradaSalida" action="lista"><i class="fa fa-book"></i> <span>Eventos</span></g:link></li>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2017-${new Date().format("yyyy")} <a href="#">PUCMM - Registro Eventos</a>.</strong> Todos los derechos reservados
    </footer>
...
<!-- DataTable -->
<script src="/webjars/AdminLTE/2.4.0/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="/webjars/AdminLTE/2.4.0/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
