            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                   %{-- <div class="box-header with-border">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <g:form role="form" action="procesarEdicion" useToken="true">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email" id="email" value="${registro.email}" placeholder="Email" required>
                            </div>
                            <div class="form-group">
                                <label for="rfid">RFID</label>
                                <input type="number" class="form-control" name="rfid" id="rfid" value="${registro.rfid}" placeholder="Rfid" required>
                            </div>
                        </div>
                        <!-- /.box-body -->
